...
def bidirectional_search_dfs_bfs(start_board, goal_board):
    # Inicialização
...
def bidirectional_search_bfs_dfs(start_board, goal_board):
...
def bidirectional_search_bfs_bfs(start_board, goal_board):
...
def bidirectional_search_dfs_dfs(start_board, goal_board):
